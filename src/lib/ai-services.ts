...
Now perform a comprehensive, state-of-the-art BIM analysis using this advanced framework. If the user requests model generation or modifications, use the available CAD tools autonomously.`;
